...
function DeletarCategoria() {
    ...
    async function buscarPorId(id: string) {
        try {
            ...
            if (error.toString().includes('402')) {
    ...
    return (
        <div className="container w-1/3 mx-auto">
            ...
            <div className="border flex flex-col rounded-2x1 overflow-hidden justify-between ">
                <header className="py-2 text-3x1 bg-slate-200 h-full"> Categoria</header>
                <p className="p-8 text-3x1 bg-slate-200 h-full">{categoria.tipo}</p>
                <div className="flex">
